        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Recorded_by = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendances_AspNetUsers_Recorded_by",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subjects_Branches_Branch_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassSchedules_AspNetUsers_Teacher_id",
                        column: x => x.Teacher_id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClassSchedules_Branches_Branch_id",
                        column: x => x.Branch_id,
                        principalTable: "Branches",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ClassSchedules_Subjects_Subject_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    _Grade = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentSubjects_AspNetUsers_Student_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassSessions_ClassSchedules_Schedule_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Student_id = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Recorded_by = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SessionAttendance_ClassSessions_Session_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClassSchedules_Branch_id",
                table: "ClassSchedules",
                column: "Branch_id");

            migrationBuilder.CreateIndex(
                name: "IX_ClassSchedules_Subject_id",
                table: "ClassSchedules",
                column: "Subject_id");

            migrationBuilder.CreateIndex(
                name: "IX_ClassSchedules_Teacher_id",
                table: "ClassSchedules",
                column: "Teacher_id");

            migrationBuilder.CreateIndex(
                name: "IX_ClassSessions_Schedule_id",
                table: "ClassSessions",
                column: "Schedule_id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SessionAttendance_Recorded_by",
                table: "SessionAttendance",
                column: "Recorded_by");

            migrationBuilder.CreateIndex(
                name: "IX_SessionAttendance_Session_id",
                table: "SessionAttendance",
                column: "Session_id");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSubjects_Student_id",
